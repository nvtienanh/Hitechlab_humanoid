...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(944, 675);
        QIcon icon;
        ...
        actionCMD = new QAction(MainWindowDesign);
        actionCMD->setObjectName(QString::fromUtf8("actionCMD"));
        ...
        gridLayoutWidget->setGeometry(QRect(0, 10, 261, 471));
        ...
        dial_2 = new QDial(tab_3);
        dial_2->setObjectName(QString::fromUtf8("dial_2"));
        dial_2->setGeometry(QRect(0, 0, 111, 111));
        ...
        dial_2->setMinimum(1);
        dial_2->setMaximum(4095);
        dial_2->setSliderPosition(1);
        dial_2->setTracking(false);
        ...
        lcdNumber->setGeometry(QRect(0, 110, 101, 41));
        ...
        dock_status->setMinimumSize(QSize(325, 546));
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        actionCMD->setText(QApplication::translate("MainWindowDesign", "CMD", 0, QApplication::UnicodeUTF8));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MainWindowDesign", "Tab 1", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("MainWindowDesign", "Page", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MainWindowDesign", "Tab 2", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("MainWindowDesign", "Page", 0, QApplication::UnicodeUTF8));
        ...
        pushButton->setText(QApplication::translate("MainWindowDesign", "C bnt", 0, QApplication::UnicodeUTF8));
        pushButton_2->setText(QApplication::translate("MainWindowDesign", "A bnt", 0, QApplication::UnicodeUTF8));
